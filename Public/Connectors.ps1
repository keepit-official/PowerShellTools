...
function Get-KeepitConnector {
    ...
    begin {
        ...
        try {
            ...
            # Pre-filter by accessibility and type, build cached device list (sorted by Name)
            ...
            # Sort cached devices lexicographically by Name
            $cachedDevices = @($cachedDevices | Sort-Object -Property Name)
        }
        catch {
